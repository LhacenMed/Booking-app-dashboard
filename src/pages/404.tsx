...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden font-mono">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-black [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-white" />

      <div className="relative flex items-center gap-80">
        {/* SVG Image */}
        <div className="w-[400px]">
          ...
          >
            ...
            <g mask="url(#d)">
              <path fill="#c6c6c6" d="M34 72h483.089v447.492H34z" />
            </g>
            <path
        ...
        <div className="text-white space-y-4">
          ...
          <Link
            to="/"
            className="inline-block mt-8 px-6 py-2 bg-white text-black hover:bg-gray-100 transition-colors font-medium tracking-wide rounded-md"
          >
            TAKE ME HOME
          </Link>
        </div>
